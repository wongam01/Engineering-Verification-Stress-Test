...
def main() -> None:
    ...
    if OUTPUT_FILE.exists():
        raise FileExistsError(
            ...
            "Blind AI Extraction Run #1 will not be overwritten."
        )
    ...
    print(
        "=== PROTOTYPE BLIND AI EXTRACTION RUN #1 ==="
    )
    print(
    ...
    artifact = {
        "metadata": {
            "stage": (
                "PROTOTYPE_BLIND_AI_EXTRACTION_RUN_01"
            ),
    ...
    print()
    print(
        "Blind AI Extraction Run #1 completed."
    )
    print(
        "Do NOT rerun this baseline if the result is poor."
    )
