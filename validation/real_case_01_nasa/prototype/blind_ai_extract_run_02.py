...
def main() -> None:
    ...
    if OUTPUT_FILE.exists():
        raise FileExistsError(
            ...
            "Blind AI Extraction Run #2 will not be overwritten."
        )
    ...
    print(
        "=== PROTOTYPE BLIND AI EXTRACTION RUN #2 ==="
    )
    print(
    ...
    artifact = {
        "metadata": {
            "stage": (
                "PROTOTYPE_BLIND_AI_EXTRACTION_RUN_02"
            ),
    ...
    print()
    print(
        "Blind AI Extraction Run #2 completed."
    )
    print(
