...
def main() -> None:
    ...
    if OUTPUT_FILE.exists():
        raise FileExistsError(
            ...
            "Run B is preserved intentionally and will not be overwritten."
        )
    ...
    print("=== NASA Reference Builder — Run B ===")
    ...
    try:
        ...
        artifact = {
            "reference_metadata": {
                "reference_stage": "CANDIDATE_RUN_B",
        ...
        print("- Run B will not be overwritten.")
